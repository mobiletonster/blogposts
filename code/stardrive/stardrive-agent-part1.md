## StarDrive - Building the Client Agent - Part 1
...
### Next Steps
In the next section, we will begin to build out our client agent so it can scan directories on our filesystem.
